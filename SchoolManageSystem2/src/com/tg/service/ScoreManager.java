...
public class ScoreManager {
	...
	public void studentInfo(StudentVo studentVo, ArrayList<Subject> subjectList) {
		...
		for (int i = 0; i < subjectList.size(); i++) {
			sum = sum + subjectList.get(i).getScore();
		}
		...
		for (int i = 0; i < subjectList.size(); i++) {
			...
			studentInfoStr += subjectList.get(i).getName() 
					+ "성적 : ";
			studentInfoStr += subjectList.get(i).getScore();
			studentInfoStr += "\n";
		}
