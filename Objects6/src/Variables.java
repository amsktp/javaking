...
//	1. 인스턴스 변수 (new로 선언하는 것은 인스턴스 변수) //배열은 new를 쓰지만 인스턴스 변수는 아니다
...
//		인스턴스마다 고유한 상태를 유지해야하는 속성의 경우, 인스턴스 변수를 선언한다.

//	2. 클래스 변수
//		클래스 변수를 선언하는 방법은 인스턴스 변수 앞에 static을 붙이기만 하면 된다.
//		인스턴스 마다 독립적인 저장공간을 갖는 인스턴스변수와는 달리,
...
//		인스턴스 변수는 인스턴스를 생성한 후에야 사용가능하지만, 클래스 변수는 인스턴스를
